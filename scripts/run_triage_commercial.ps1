...
Write-Host "Pre-triaging FLAG questions (Commercial Pilot bank)..."
.\.venv\Scripts\python.exe scripts\triage_flag_questions.py --input question-bank/qbank_commercial_helicopter.json
