...
Write-Host "Pre-triaging FLAG questions (Private Pilot bank)..."
.\.venv\Scripts\python.exe scripts\triage_flag_questions.py --input question-bank/qbank_private_helicopter.json
